...
<div class="col-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            ...
            @endif
            <form class="forms-sample" method="POST" action="/AnnouncementUpdate/{{ $announcements->id }}">
                @csrf
                @method('PUT')
                <input type="hidden" name="id" value="{{ $announcements->id }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="content" name="content" rows="4" required>{{ $announcements->content }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="published_at">Publication Date</label>
                        <input type="date" class="form-control" id="published_at" name="published_at"
                        value="{{ $announcements->published_at }}" required>
                    </div>
                    <button type="submit" class="btn btn-primary me-2">Edit</button>
                    <a href="/Annoucementlist" class="btn btn-light">back</a>
                </form>
        </div>
    </div>
</div>
