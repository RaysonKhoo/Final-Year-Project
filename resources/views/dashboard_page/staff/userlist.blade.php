...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h2 mb-4" style="color: black">List of User <i class="fa fa-user-friends"></i></h1>
    <!-- DataTales Example -->
                ...
                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="none">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form onsubmit="return confirmdeleted(event)"
                                action="/Userdeleted/{{ $info->id }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn-sm btn-danger">Deleted
                                </button>
                            </form>
                            </td>
                        </tr>
...
<script>
    function confirmdeleted(event)
    {
        ...
        Swal.fire({
            ...
            text: "Deleted data cannot be return back",
            icon: 'warning',
