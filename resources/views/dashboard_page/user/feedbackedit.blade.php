...
@endif
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Edit Feedback Form') }}</div>
                    <div class="card-body">
                        <form name="edit feedback" action="{{ route('Feedback.update', $Feedback->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <input type="hidden" name="feedback_id" value="{{ $Feedback->id }}">
                            <div class="form-group">
                                <label for="name">{{ __('Username') }}</label>
                                <input id="name" type="text" class="form-control" name="name" value="{{$Feedback->name}}" required>
                                @if($errors->any('name'))
                            ...
                            <div class="form-group">
                                ...
                                <input id="email" type="text" class="form-control" name="email" value="{{$Feedback->email}}" required>
                                @if($errors->any('email'))
                            ...
                            <div class="form-group">
                                ...
                                <input id="phone_number" type="text" class="form-control" name="phone_number" value="{{$Feedback->phone_number}}" required>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="message" class="form-control" name="content" rows="4" required>{{ old('content', $Feedback->content) }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <a href="/feedbacklist" class="btn btn-danger">back</a>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script>
        // Function to display the success alert
        ...
        // Execute the displaySuccessAlert function when the DOM is fully loaded
