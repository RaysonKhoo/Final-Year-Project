...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h2 mb-4 text-center" style="color: black">List of User <i class="fa fa-user-friends"></i></h1>
    <div class="d-flex justify-content-end mb-4">
        <a href="{{ route('userlist.pdf') }}" class="btn btn-primary">Generate PDF</a>
    </div>
    <!-- DataTales Example -->
